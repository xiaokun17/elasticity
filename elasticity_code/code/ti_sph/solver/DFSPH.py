...
class DFSPH(SPH_kernel):
    def __init__(
        ...
        self.obj_force = eval("self.obj." + port_force)
    ...
    #                     dis = x_ij.norm()
    #                     if bigger_than_zero(dis):
    #                         self.obj_vel_adv[pid] += self.inv_dt * from_solver.obj_force[nid] / self.obj_mass[pid]
